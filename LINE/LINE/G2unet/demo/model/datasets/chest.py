...
class Chest(data.Dataset):
    ...
    def __init__(self, prefix, phase, transform_params=dict(), sigma=5, num_landmark=10, size=[512, 512], use_abnormal=True, chest_set=None, exclude_list=None,use_background_channel=False):
